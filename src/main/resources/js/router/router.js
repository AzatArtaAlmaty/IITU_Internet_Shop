...
import admin from 'pages/adminNew/admin.vue'
import cart from 'pages/cart/cart.vue'
import checkout from 'pages/checkout/checkout.vue'
import NotFound from 'pages/404/404.vue'
import Description from 'pages/ItemDescription/Description.vue'
...
const routes = [
    ...
    { path: '/desp', name: "Description", component: Description, props:true },
